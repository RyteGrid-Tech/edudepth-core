  ...
  head: () => ({
    meta: [
      { title: "EduDepth Concepts — Operating system for Nigerian students" },
      {
        name: "description",
        content:
          "Structured WAEC, NECO and JAMB prep. Subject by subject. Topic by topic. Built to clear exams.",
      },
      { property: "og:title", content: "EduDepth Concepts" },
      {
        property: "og:description",
        content: "The operating system for Nigerian students who study to pass.",
      },
    ],
  }),
  component: HomePage,
...
const MODULES = [
  ...
  },
  {
    ...
    level: "SS1–SS3",
    lessons: 124,
    topics: ["Atomic Theory", "Organic", "Inorganic", "Acids & Bases"],
  },
  {
    code: "BIO101",
    title: "Biology",
    level: "SS1–SS3",
    lessons: 136,
    topics: ["Cells", "Genetics", "Ecology", "Human Anatomy"],
  },
  {
    code: "ENG101",
    ...
    level: "SS1–SS3",
    lessons: 98,
    topics: ["Comprehension", "Lexis", "Oral", "Essay"],
  },
  {
    code: "ECN101",
    title: "Economics",
    level: "SS2–SS3",
    lessons: 86,
    topics: ["Demand", "Supply", "Macro", "Public Finance"],
  },
];
    ...
    <div className="min-h-screen bg-bg-primary text-text-primary">
      ...
      <section className="px-5 md:px-8 pt-12 md:pt-20 pb-16 max-w-6xl mx-auto">
        ...
        <p className="text-base md:text-lg text-text-secondary mt-6 max-w-2xl leading-relaxed">
          Structure beats motivation. Every time. EduDepth is the operating system for Nigerian
          students who are done guessing and ready to clear WAEC, NECO and JAMB — by subject, by
          topic, by result.
        </p>
      ...
      <section className="border-y border-border bg-bg-surface">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4">
          {STATS.map((s, i) => (
            ...
            >
              <div className="font-mono text-2xl md:text-4xl font-bold text-text-primary">
                {s.value}
              </div>
      ...
      <section className="px-5 md:px-8 py-16 md:py-20 max-w-6xl mx-auto">
        <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
          <div>
            ...
            <p className="text-text-secondary mt-2 max-w-xl">
              Curriculum-aligned modules built for WAEC, NECO and JAMB. Every lesson sequenced.
              Every topic accountable.
            </p>
          </div>
          <Link
            to="/auth"
            className="label-mono text-accent hover:text-text-primary transition-colors"
          >
            VIEW ALL →
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-border">
          {MODULES.map((m) => (
            <div
              key={m.code}
              className="bg-bg-card p-6 hover:bg-bg-surface transition-colors group cursor-pointer border-l-2 border-transparent hover:border-accent"
            >
              <div className="flex items-start justify-between mb-4">
                <span className="font-mono text-xs text-accent">{m.code}</span>
                <span className="label-mono text-text-muted border border-border px-2 py-1">
                  {m.level}
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-1.5 mb-5">
                {m.topics.map((t) => (
                  <span
                    key={t}
                    className="font-mono text-[10px] text-text-secondary border border-border px-2 py-0.5"
                  >
                    {t}
                  </span>
                ))}
              ...
              <div className="flex items-center justify-between pt-4 border-t border-border">
                ...
                <span className="label-mono text-accent group-hover:translate-x-1 transition-transform">
                  DEPLOY →
                </span>
              </div>
            </div>
            ...
            {[
              {
                n: "01",
                t: "Right Inputs",
                d: "Verified curriculum content. No filler. No tangents. What WAEC asks, you study.",
              },
              {
                n: "02",
                t: "Right Systems",
                d: "Sequenced lessons. Locked progression. Assessments after every clear. No shortcuts.",
              },
              {
                n: "03",
                t: "Right Outcomes",
                d: "Trackable performance. Honest scores. Real readiness before exam day.",
              },
            ].map((p) => (
      ...
      <section className="px-5 md:px-8 py-20 max-w-4xl mx-auto text-center">
        ...
        <p className="text-text-secondary mt-4 max-w-xl mx-auto">
          Initialize your account. Deploy your first module. Start operating.
        </p>
        <Link
          to="/auth"
